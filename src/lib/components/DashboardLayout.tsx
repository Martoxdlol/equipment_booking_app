...
//     const loaded = props.requireNamespace ? !!namespace : (session.status === "authenticated" || session.status === "unauthenticated")
...
//                                 height={32}
//                                 width={32}
//                                 src={`/api/files/namespaces/${namespaceSlug || 'null'}/picture`}
//                                 alt="Logo"
...
//                         {authed && <Link className="hidden items-center rounded p-1 text-lg font-medium leading-3 text-primary transition sm:flex" href={props.titleHref || `/${namespaceSlug || '-'}`}>{props.title || session.data.user.name}</Link>}
//                         {!loaded && <a className="hidden items-center rounded p-1 text-lg font-medium leading-3 text-primary transition sm:flex">Cargando...</a>}
